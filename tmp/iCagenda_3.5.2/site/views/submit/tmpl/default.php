...
//		}
	...
	<div id="icagenda" class="ic-submit-view<?php echo $this->pageclass_sfx; ?>">
		...
		<form id="submitevent" action="<?php echo JRoute::_('index.php?option=com_icagenda'); ?>" method="post" class="icagenda_form<?php echo $form_validate; ?>" enctype="multipart/form-data"<?php echo $iCheckForm . $novalidate; ?>>
			<div>
